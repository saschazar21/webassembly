...
const HEIF_TEST_IMAGE = 'https://res.cloudinary.com/demo/image/fetch/f_heic/https://source.unsplash.com/random/1440x960';
...
describe('HEIF', () => {
  ...
  it('decodes a HEIF image', async () => {
    const buf = new Uint8Array(await fetch(HEIF_TEST_IMAGE).then(res => res.buffer()));
