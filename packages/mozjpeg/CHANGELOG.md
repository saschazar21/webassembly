...
- chore(mozjpeg): moved build script to CMake ([@saschazar21](https://github.com/saschazar21))
...
- chore(mozjpeg): updated tests, enhanced README ([@saschazar21](https://github.com/saschazar21))
...
- chore(mozjpeg): updated README ([@saschazar21](https://github.com/saschazar21))
